...
class LoginScreen(Screen):
    ...
    def login(self, uname, pword):
        ...
        if uname in users and users[uname]['password'] == pword:
            ...
            # print("login unsuccessful for user {} with password {}".format(uname, pword))
...
class LoginScreenSuccess(Screen):
    ...
    def get_quote(self, feel):
        feel = feel.lower()
        available_feelings = glob.glob(u'./quotes/*.txt')
...
# ButtonBehavior should be the first param or button won't work
